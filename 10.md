...
8. List the directory and note the instances
    ...
    `[root@compute1 instances]#`  `/instance-<instance id>/console.log`

    ```	
    drwxr-xr-x. 2 nova nova 69 Oct  4 20:20 07334a4c-dac3-474b-83f0-1d8f4db1f093
    drwxr-xr-x. 2 nova nova 69 Nov  4 20:26 6a56b82f-547d-440b-9ebc-04813a343a2a
...
9. Display cinder-volume logs (on block storage nodes)
