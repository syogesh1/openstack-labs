...
11. Inspect the log files found in here. No special analysis required on your part, just check out the logs
    ...
    >Use the **cat** or **less** command to look at thes files. Hints are shown above
